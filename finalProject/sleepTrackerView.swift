...
struct sleepTrackerView: View {
    ...
    func getPersonalizedMessage(hours: Int) -> String {
        if hours >= 10 {
            return "You had a too much sleep! Although it is good to get a good night's rest, keep in mind that getting to much sleep can also be a bad thing!"
        } else if hours <= 6 {
            ...
            return "You slept for just the right amount of hours. Keep up the good work and remember to sleep at consistant hours so that your body maintains its sleep schedule and you wake up to feel the most well rested!"
        }
    }
}
